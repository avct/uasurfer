...
// Test values are ordered: BrowserName, Version, OSName, OSVersion, DeviceType
var testUAVars = []struct {
	...
	{"Mozilla/5.0 (iPhone; U; CPU iPhone OS 5_1_1 like Mac OS X; en) AppleWebKit/534.46.0 (KHTML, like Gecko) CriOS/19.0.1084.60 Mobile/9B206 Safari/534.48.3",
		Chrome, 19, PlatformiPhone, OSiOS, 5, Phone},
	...
	// 	Chrome, 28, PlatformLinux, OSAndroid, 4, Phone},

	// Safari
	{"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_4) AppleWebKit/600.7.12 (KHTML, like Gecko) Version/8.0.7 Safari/600.7.12",
		Safari, 8, PlatformMac, OSMacOSX, 10, Computer},

	{"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_5; en-us) AppleWebKit/525.26.2 (KHTML, like Gecko) Version/3.2 Safari/525.26.12",
		Safari, 3, PlatformMac, OSMacOSX, 5, Computer},

	// Firefox
	{"Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/1.0 Mobile/12F69 Safari/600.1.4",
		Firefox, 1, PlatformiPhone, OSiOS, 8, Phone},

	{"Mozilla/5.0 (Android 4.4; Tablet; rv:41.0) Gecko/41.0 Firefox/41.0",
		Firefox, 41, PlatformLinux, OSAndroid, 4, Tablet},

	{"Mozilla/5.0 (Android; Mobile; rv:40.0) Gecko/40.0 Firefox/40.0",
		Firefox, 40, PlatformLinux, OSAndroid, 0, Phone},

	{"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:38.0) Gecko/20100101 Firefox/38.0",
		Firefox, 38, PlatformLinux, OSLinux, 0, Computer},
	...
	{"Mozilla/5.0 (Linux; U; Android 4.4.3; de-de; KFTHWI Build/KTU84M) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.47 like Chrome/37.0.2026.117 Safari/537.36",
		Silk, 3, PlatformLinux, OSKindle, 4, Tablet},
	...
	{"Mozilla/5.0 (Windows Phone 10.0; Android 4.2.1; DEVICE INFO) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Mobile Safari/537.36 Edge/12.123",
		IE, 12, PlatformWindowsPhone, OSWindowsPhone, 10, Phone},

	{"Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; Lumia 520) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537",
		IE, 11, PlatformWindowsPhone, OSWindowsPhone, 8, Phone},

	{"Mozilla/4.0 (compatible; MSIE 5.01; Windows NT 5.0; SV1; .NET CLR 1.1.4322; .NET CLR 1.0.3705; .NET CLR 2.0.50727)",
		IE, 5, PlatformWindows, OSWindows2000, 5, Computer},
	...
	{"Mozilla/5.0 (Linux; U; Android 2.3.4; en-US; MT11i Build/4.0.2.A.0.62) AppleWebKit/534.31 (KHTML, like Gecko) UCBrowser/9.0.1.275 U3/0.8.0 Mobile Safari/534.31",
		UCBrowser, 9, PlatformLinux, OSAndroid, 2, Phone},
	...
	{"Mozilla/5.0 (Linux; U; Android 4.0.4; en-US; Micromax P255 Build/IMM76D) AppleWebKit/534.31 (KHTML, like Gecko) UCBrowser/9.2.0.308 U3/0.8.0 Mobile Safari/534.31",
		UCBrowser, 9, PlatformLinux, OSAndroid, 4, Phone},

	{"UCBrowserWEB/2.0 (Java; U; MIDP-2.0; en-US; MicromaxQ5) U2/1.0.0 UCBrowser/9.4.0.342 U2/1.0.0 Mobile",
		UCBrowser, 9, PlatformUnknown, OSUnknown, 0, Phone},

	// Nokia
	// {"Mozilla/5.0 (Series40; Nokia501/14.0.4/java_runtime_version=Nokia_Asha_1_2; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40Ovi/4.0.0.0.45",
	// 	Unknown, 4, PlatformUnknown, OSUnknown, 0, Phone},

	// {"Mozilla/5.0 (Symbian/3; Series60/5.3 NokiaN8-00/111.040.1511; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) Nokia/8.3.1.4 Mobile Safari/535.1",
	// 	Unknown, 8, PlatformUnknown, OSUnknown, 0, Phone},

	// {"NokiaN97/21.1.107 (SymbianOS/9.4; Series60/5.0 Mozilla/5.0; Profile/MIDP-2.1 Configuration/CLDC-1.1) AppleWebkit/525 (KHTML, like Gecko) NG/7.1.4",
	// 	Unknown, 7, PlatformUnknown, OSUnknown, 0, Phone},

	// ChromeOS
	{"Mozilla/5.0 (X11; U; CrOS i686 9.10.0; en-US) AppleWebKit/532.5 (KHTML, like Gecko) Chrome/4.0.253.0 Safari/532.5",
		Chrome, 4, PlatformLinux, OSChromeOS, 0, Computer},

	// WebOS
	{"Mozilla/5.0 (hp-tablet; Linux; hpwOS/3.0.0; U; de-DE) AppleWebKit/534.6 (KHTML, like Gecko) wOS/233.70 Safari/534.6 TouchPad/1.0",
		BrowserUnknown, 0, PlatformLinux, OSWebOS, 0, Tablet},
	...
	{"Mozilla/5.0 (Linux; U; Android 2.2; en-us; DROID2 GLOBAL Build/S273) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
		Android, 4, PlatformLinux, OSAndroid, 2, Phone},
	...
	{"Mozilla/5.0 (Linux; U; Android 4.0.3; de-ch; HTC Sensation Build/IML74K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari53/4.30",
		Android, 4, PlatformLinux, OSAndroid, 4, Phone},

	// BlackBerry
	{"Mozilla/5.0 (PlayBook; U; RIM Tablet OS 2.1.0; en-US) AppleWebKit/536.2+ (KHTML, like Gecko) Version/7.2.1.0 Safari/536.2+",
		Blackberry, 7, PlatformBlackberry, OSBlackberry, 0, Tablet},

	{"Mozilla/5.0 (BB10; Kbd) AppleWebKit/537.35+ (KHTML, like Gecko) Version/10.2.1.1925 Mobile Safari/537.35+",
		Blackberry, 10, PlatformBlackberry, OSBlackberry, 0, Phone},
	...
	{"Mozilla/5.0 (Linux; U; Android 4.4.3; de-de; KFTHWI Build/KTU84M) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.67 like Chrome/39.0.2171.93 Safari/537.36",
		Silk, 3, PlatformLinux, OSKindle, 4, Tablet}, // Fire tablet
	...
	{"Mozilla/5.0 (Linux; U; Android 4.2.2; en­us; KFTHWI Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.22 like Chrome/34.0.1847.137 Mobile Safari/537.36",
		Silk, 3, PlatformLinux, OSKindle, 4, Tablet}, // Fire tablet, but with "Mobile"
	...
	{"Mozilla/5.0 (Linux; Android 4.4.4; SD4930UR Build/KTU84P) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/34.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/35.0.0.48.273;]",
		Chrome, 34, PlatformLinux, OSKindle, 4, Phone}, // Facebook app on Fire Phone
	...
	// 	Silk, 3, PlatformLinux, OSKindle, 4, Phone}, // Silk on Fire Phone

	// Nintendo
	{"Opera/9.30 (Nintendo Wii; U; ; 2047-7; fr)",
		Opera, 9, PlatformNintendo, OSNintendo, 0, Console},

	{"Mozilla/5.0 (Nintendo WiiU) AppleWebKit/534.52 (KHTML, like Gecko) NX/2.1.0.8.21 Nintendo/1.0.0.7494.US",
		BrowserUnknown, 0, PlatformNintendo, OSNintendo, 0, Console},

	// Xbox
	{"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0; Xbox)", //Xbox 360
		IE, 9, PlatformXbox, OSXbox, 6, Console},

	// Playstation

	{"Mozilla/5.0 (Playstation Vita 1.61) AppleWebKit/531.22.8 (KHTML, like Gecko) Silk/3.2",
		Silk, 3, PlatformPlaystation, OSPlaystation, 0, Console},
	...
	{"Mozilla/5.0 (CrKey armv7l 1.4.15250) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.0 Safari/537.36", // Chromecast
		Chrome, 31, PlatformUnknown, OSUnknown, 0, TV},
	...
	{"Mozilla/5.0 (Linux; GoogleTV 3.2; VAP430 Build/MASTER) AppleWebKit/534.24 (KHTML, like Gecko) Chrome/11.0.696.77 Safari/534.24", // Google TV
		Chrome, 11, PlatformLinux, OSUnknown, 0, TV},
	...
	{"Mozilla/5.0 (Linux; Android 5.0; ADT-1 Build/LPX13D) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.89 Mobile Safari/537.36", // Android TV
		Chrome, 40, PlatformLinux, OSAndroid, 5, TV},
	...
	{"Mozilla/5.0 (Linux; Android 4.2.2; AFTB Build/JDQ39) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.173 Mobile Safari/537.22", // Amazon Fire
		Chrome, 25, PlatformLinux, OSAndroid, 4, TV},

	{"Mozilla/5.0 (Unknown; Linux armv7l) AppleWebKit/537.1+ (KHTML, like Gecko) Safari/537.1+ LG /6.00.00(+mouse+3D+SCREEN+TUNER; LGE; GLOBAL-PLAT5; 03.07.01; 0x00000001;); LG NetCast.TV-2013/03.17.01 (LG, GLOBAL-PLAT4, wired)", // LG TV
		BrowserUnknown, 0, PlatformLinux, OSUnknown, 0, TV},
	...
	{"Mozilla/5.0 (X11; FreeBSD; U; Viera; de-DE) AppleWebKit/537.11 (KHTML, like Gecko) Viera/3.10.0 Chrome/23.0.1271.97 Safari/537.11", // Panasonic Viera
		Chrome, 23, PlatformLinux, OSLinux, 0, TV},

	{"Mozilla/5.0 (DTV) AppleWebKit/531.2+ (KHTML, like Gecko) Espial/6.1.5 AQUOS/2.0 (US01DTV;V;0001;0001)", // Sharp Aquos
		BrowserUnknown, 0, PlatformUnknown, OSUnknown, 0, TV},
	...
	{"Mozilla/5.0 (iPad; CPU OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) GSA/6.0.51363 Mobile/12F69 Safari/600.1.4",
		Safari, 8, PlatformiPad, OSiOS, 8, Tablet},
	...
	{"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.45 Safari/535.19", //chrome for android having requested desktop site
		Chrome, 18, PlatformLinux, OSLinux, 0, Computer},

	{"Opera/9.80 (S60; SymbOS; Opera Mobi/352; U; de) Presto/2.4.15 Version/10.00",
		Opera, 10, PlatformUnknown, OSUnknown, 0, Phone},
}
