...
func _() {
	...
	_ = x[DeviceTV-6]
	_ = x[DeviceMediaHub-7]
}

const _DeviceType_name = "DeviceUnknownDeviceComputerDeviceTabletDevicePhoneDeviceConsoleDeviceWearableDeviceTVDeviceMediaHub"

var _DeviceType_index = [...]uint8{0, 13, 27, 39, 50, 63, 77, 85, 99}
