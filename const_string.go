...
func _() {
	...
	_ = x[BrowserOperaMini-20]
	_ = x[BrowserPuffin-21]
	_ = x[BrowserFBApp-22]
	_ = x[BrowserBot-23]
	_ = x[BrowserAppleBot-24]
	_ = x[BrowserBaiduBot-25]
	_ = x[BrowserBingBot-26]
	_ = x[BrowserDuckDuckGoBot-27]
	_ = x[BrowserFacebookBot-28]
	_ = x[BrowserGoogleBot-29]
	_ = x[BrowserLinkedInBot-30]
	_ = x[BrowserMsnBot-31]
	_ = x[BrowserPingdomBot-32]
	_ = x[BrowserTwitterBot-33]
	_ = x[BrowserYandexBot-34]
	_ = x[BrowserCocCocBot-35]
	_ = x[BrowserYahooBot-36]
}

const _BrowserName_name = ""

var _BrowserName_index = [...]uint16{0, 14, 27, 36, 49, 63, 77, 89, 106, 122, 133, 145, 160, 169, 183, 203, 217, 232, 246, 259, 272, 288, 301, 313, 323, 338, 353, 367, 387, 405, 421, 439, 452, 469, 486, 502, 518, 533}
...
func _() {
	...
	_ = x[PlatformOracle-12]
	_ = x[PlatformBot-13]
}

const _Platform_name = "PlatformUnknownPlatformWindowsPlatformMacPlatformLinuxPlatformiPadPlatformiPhonePlatformiPodPlatformBlackberryPlatformWindowsPhonePlatformPlaystationPlatformXboxPlatformNintendoPlatformOraclePlatformBot"

var _Platform_index = [...]uint8{0, 15, 30, 41, 54, 66, 80, 92, 110, 130, 149, 161, 177, 191, 202}
