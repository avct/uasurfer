...
var testUAVars = []struct {
	...
	// iPhone
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{6, 0, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{7, 0, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{8, 0, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{8, 0, 2},
			},
			DevicePhone,
		},
	},
	...
	// iPad
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{4, 0, 4},
			},
			OS{
				PlatformiPad, OSiOS, Version{3, 2, 0},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformiPad, OSiOS, Version{9, 0, 0},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{10, 0, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{10, 0, 0},
			},
			DevicePhone,
		},
	},
	// Chrome
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{43, 0, 2357},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 10, 4},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{19, 0, 1084},
			},
			OS{
				PlatformiPhone, OSiOS, Version{5, 1, 1},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{46, 0, 2490},
			},
			OS{
				PlatformLinux, OSAndroid, Version{6, 0, 0},
			},
			DevicePhone,
		},
	},
	// Chromium (Chrome)
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{18, 0, 1025},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{45, 0, 2454},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 11, 0},
			},
			DeviceComputer,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{3, 2, 0},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 5, 5},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformMac, OSMacOSX, Version{10, 12, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{88, 0, 4324},
			},
			OS{
				PlatformMac, OSMacOSX, Version{11, 1, 0},
			},
			DeviceComputer,
		},
	},
	// Firefox
	{
		...
		UserAgent{
			Browser{
				BrowserFirefox, Version{1, 0, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{8, 3, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserFirefox, Version{41, 0, 0},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 4, 0},
			}, DeviceTablet,
		},
	},
	...
	// Silk
	{
		...
		UserAgent{
			Browser{
				BrowserSilk, Version{3, 47, 0},
			},
			OS{
				PlatformLinux, OSKindle, Version{4, 4, 3},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSilk, Version{2, 4, 0},
			},
			OS{
				PlatformLinux, OSKindle, Version{0, 0, 0},
			},
			DeviceTablet,
		},
	},
	// Opera
	{
		...
		UserAgent{
			Browser{
				BrowserOpera, Version{18, 0, 1284},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 1, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserOpera, Version{10, 2, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{8, 4, 0},
			},
			DevicePhone,
		},
	},
	// Internet Explorer -- https://msdn.microsoft.com/en-us/library/hh869301(v=vs.85).aspx
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{12, 123, 0},
			},
			OS{
				PlatformWindows, OSWindows, Version{10, 0, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{10, 0, 0},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 2, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{11, 0, 0},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 3, 0},
			},
			DeviceComputer,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{42, 0, 2},
			},
			OS{
				PlatformLinux, OSAndroid, Version{9, 0, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{76, 0, 176},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 14, 5},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{10, 0, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{8, 1, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{5, 0, 1},
			},
			OS{
				PlatformWindows, OSWindows, Version{5, 0, 0},
			},
			DeviceComputer,
		},
	},
	...
	// UC Browser
	{
		...
		UserAgent{
			Browser{
				BrowserUCBrowser, Version{9, 0, 1},
			},
			OS{
				PlatformLinux, OSAndroid, Version{2, 3, 4},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserUCBrowser, Version{9, 2, 0},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 0, 4},
			},
			DevicePhone},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserUCBrowser, Version{9, 4, 0},
			},
			OS{
	...
	// ChromeOS
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{4, 0, 253},
			},
			OS{
				PlatformLinux, OSChromeOS, Version{0, 0, 0},
			},
			DeviceComputer,
		},
	},
	// iPod, iPod Touch
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{9, 0, 0},
			},
			OS{
				PlatformiPod, OSiOS, Version{9, 3, 3},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformiPod, OSiOS, Version{6, 1, 6},
			},
			DeviceTablet,
		},
	},
	...
	// Android WebView (Android <= 4.3)
	{
		...
		UserAgent{
			Browser{
				BrowserAndroid, Version{4, 0, 0},
			},
			OS{
				PlatformLinux, OSAndroid, Version{2, 2, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{4, 0, 3},
			},
			DevicePhone,
		},
	},
	// BlackBerry
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{7, 2, 1},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{10, 2, 1},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{0, 0, 0},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0},
			},
	...
	// Windows Phone
	{
		...
		UserAgent{
			...
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{8, 0, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{9, 0, 0},
			},
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{7, 5, 0},
			},
			DevicePhone,
		},
	},
	...
	// Fire tablet
	{
		...
		UserAgent{
			Browser{
				BrowserSilk, Version{3, 22, 0},
			},
			OS{
				PlatformLinux, OSKindle, Version{4, 2, 2},
			},
			DeviceTablet,
		},
	},
	...
	// Xbox
	{
		...
		UserAgent{
			...
			OS{
				PlatformXbox, OSXbox, Version{6, 1, 0},
			},
			DeviceConsole,
		},
	},
	...
	// Smart TVs and TV dongles
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{83, 0, 4103},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{31, 0, 1650},
			},
			OS{
				PlatformLinux, OSAndroid, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{11, 0, 696},
			},
			OS{
				PlatformLinux, OSAndroid, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{40, 0, 2214},
			},
			OS{
				PlatformLinux, OSAndroid, Version{5, 0, 0},
			},
			DeviceTV,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{25, 0, 1364},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{23, 0, 1271},
			},
			OS{
				PlatformLinux, OSLinux, Version{0, 0, 0},
			},
	...
	// Spotify (applicable for advertising applications)
	{
		...
		UserAgent{
			Browser{
				BrowserSpotify, Version{1, 0, 9},
			},
			OS{
				PlatformWindows, OSWindows, Version{5, 1, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformMac, OSMacOSX, Version{10, 10, 2},
			},
			DeviceComputer,
		},
	},
	// OCSP fetchers
	{
		...
		UserAgent{
			...
			OS{
				PlatformWindows, OSUnknown, Version{0, 0, 0},
			},
			DeviceComputer,
		},
	},
	...
	// Bots
	{
		...
		UserAgent{
			Browser{
				BrowserAppleBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{10, 10, 1},
			},
			DeviceComputer,
		},
	},

	{
		...
		UserAgent{
			Browser{
				BrowserBaiduBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
			DeviceComputer,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{BrowserDuckDuckGoBot, Version{0, 0, 0}},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
			DeviceComputer,
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserFacebookBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserGoogleBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserLinkedInBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserPingdomBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserTwitterBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserYandexBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformBot, OSBot, Version{6, 0, 1},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformBot, OSBot, Version{6, 0, 0},
			},
			DeviceComputer,
		},
	},
	...
	// Unknown or partially handled
	{
		...
		UserAgent{
			Browser{
				BrowserFirefox, Version{0, 0, 0},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 4, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformMac, OSMacOSX, Version{10, 5, 0},
			},
			DeviceComputer,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserQQ, Version{5, 3, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{8, 1, 2},
			},
			DevicePhone,
		},
	},
	// ANDROID TESTS
	{
		...
		UserAgent{
			Browser{
				BrowserAndroid, Version{3, 0, 4},
			},
			OS{
				PlatformLinux, OSAndroid, Version{1, 0, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{1, 0, 3},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserAndroid, Version{3, 1, 2},
			},
			OS{
				PlatformLinux, OSAndroid, Version{1, 5, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{1, 6, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{2, 1, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{2, 2, 1},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserAndroid, Version{5, 0, 0},
			},
			OS{
				PlatformLinux, OSAndroid, Version{2, 3, 3},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{2, 3, 5},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{2, 3, 7},
			},
			DevicePhone,
		},
	},
	// TODO: is tablet, not phone
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{3, 0, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{4, 0, 1},
			},
			DevicePhone,
		},
	},
	...
	//		Browser{BrowserChrome, Version{16,0,0}}, OS{PlatformLinux, OSAndroid, Version{4,0,0}}, DevicePhone}},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{4, 1, 1},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{4, 1, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{4, 2, 0},
			},
			DeviceTablet,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{27, 0, 1453},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 3, 0},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{30, 0, 1599},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 4, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{52, 0, 2743},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformLinux, OSAndroid, Version{7, 0, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{10, 1, 0},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserBlackberry, Version{7, 1, 0},
			},
			OS{
				PlatformBlackberry, OSBlackberry, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{34, 0, 1847},
			},
			OS{
				PlatformLinux, OSChromeOS, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{4, 0, 5},
			},
			OS{
				PlatformiPhone, OSiOS, Version{4, 0, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{5, 1, 0},
			},
			OS{
				PlatformiPhone, OSiOS, Version{5, 0, 0},
			},
			DevicePhone,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformiPad, OSiOS, Version{5, 0, 0},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformiPad, OSiOS, Version{6, 0, 0},
			},
			DeviceTablet},
	},
	{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{7, 0, 0},
			},
			OS{
				PlatformiPad, OSiOS, Version{7, 0, 0},
			},
			DeviceTablet,
		},
	},

	{
		...
		UserAgent{
			...
			OS{
				PlatformiPad, OSiOS, Version{7, 0, 2},
			},
			DeviceTablet,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{5, 0, 329},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 6, 2},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserFirefox, Version{3, 5, 6},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 6, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{5, 1, 2},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 7, 2},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformMac, OSMacOSX, Version{10, 7, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{16, 0, 912},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 7, 2},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{5, 2, 0},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 8, 0},
			},
			DeviceComputer,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSafari, Version{6, 1, 0},
			},
			OS{
				PlatformMac, OSMacOSX, Version{10, 9, 0},
			},
			DeviceComputer,
		},
	},
	{
		...
		UserAgent{
			...
			OS{
				PlatformMac, OSMacOSX, Version{10, 10, 0},
			},
			DeviceComputer,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserYandex, Version{1, 0, 1084},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 2, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{24, 0, 1295},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 2, 0},
			},
...

	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{8, 0, 0},
			},
			OS{
				PlatformWindows, OSWindows, Version{6, 0, 0},
			},
			DeviceComputer,
		},
	},
	...
	// Can't parse due to limitation of user agent library
	{
		...
		UserAgent{
			Browser{
				BrowserIE, Version{6, 0, 0},
			},
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{6, 5, 3},
			},
			DevicePhone,
		},
	},
	...
	// mobile mode for Windows Phone 7
	{
		...
		UserAgent{
			...
			OS{
				PlatformWindowsPhone, OSWindowsPhone, Version{7, 0, 0},
			},
			DevicePhone,
		},
	},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserCocCocBot, Version{0, 0, 0},
			},
			OS{
				PlatformBot, OSBot, Version{0, 0, 0},
			},
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{63, 0, 3239},
			},
			OS{
				PlatformLinux, OSAndroid, Version{4, 4, 4},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserSilk, Version{70, 4, 2},
			},
			OS{
				PlatformLinux, OSAndroid, Version{5, 1, 1},
			},
			DeviceTablet,
		},
	},
	{
		...
		UserAgent{
			Browser{
				BrowserChrome, Version{64, 0, 3282},
			},
			OS{
	...
	},
	{
		...
		UserAgent{
			Browser{
				BrowserNetFront, Version{1, 7412, 0},
			},
			OS{
				PlatformNintendo, OSNintendo, Version{0, 0, 0},
			},
